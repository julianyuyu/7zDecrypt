...
//static const CSwitchForm kSwitchForms_Decrypt[] =
//{
//    { "?" },
//{ "h" },
//{ "-help" },
...
{
    RELEASE_CODECS_OBJECT(codecs);
    return 0;
}

//
// parse cmdstrings to options, init codecs.
//
    ...
    wchar_t* PatternFile)
{
    //JULIAN
    //bool isExtractGroupCommand = options.Command.IsFromExtractGroup();
    if (options.Command.CommandType != NCommandType::kTest)
    {
        // use "test" command for decrypting.
    ...
    */
    ...
    else
    {
        ...
        else
        {
            ...
            */
            ...
            //JULIAN
            *g_StdStream << "failed to enumerate items!" << endl;
    ...
    if (hresultMain == S_OK)
    {
        ...
        CDecryptCallbackConsole *ecs = new CDecryptCallbackConsole;
